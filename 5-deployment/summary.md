...
This is enough for the portfolio because the project is a static collection of Markdown reports, notebooks, scripts, and selected result files. No separate server or application deployment is needed.
