...
Overall, the final conclusion is stronger than the earlier draft: ResNet18 transfer learning is the right default model family for this dataset. The implementation scripts remain part of the chapter, while generated databases, temporary tuning outputs, and regenerated figures are treated as local experiment artefacts rather than core report content.
